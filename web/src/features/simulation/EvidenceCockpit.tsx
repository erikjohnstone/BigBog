...
import { useAlfalfaEvidence, useBoptestEvidence } from '../../api/queries';
...
export type EvidenceKind = 'boptest' | 'alfalfa';
 ...
 */
export function EvidenceCockpit({ runId, onLoad }: { runId: string; onLoad: (kind: EvidenceKind) => void }) {
