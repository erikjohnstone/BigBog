...
- Carry approved ctrl-flow artifacts into generation through the fail-closed candidate preflight. **Implemented through immutable evidence-chain verification, parameter and converter gates, typed graph boundary binding, target assessment, and replay of every approved oracle. Candidate retention/diff and recursive lowering of full G36 parent controllers remain; the present AHU parent fails visibly on unresolved nested composites rather than generating guessed logic.**
