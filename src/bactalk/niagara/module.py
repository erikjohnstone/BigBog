...
COMPONENTS: tuple[ComponentSpec, ...] = (
    ...
    ComponentSpec(
        "IntegratorWithReset",
        "com/bactalk/g36/BIntegratorWithReset",
        (BlockKind.NUMERIC_INTEGRATOR_WITH_RESET,),
        (
            ("in", _STATUS_NUMERIC, "input"),
            ("resetValue", _STATUS_NUMERIC, "input"),
            ("trigger", _STATUS_BOOLEAN, "input"),
            ("out", _STATUS_NUMERIC, "output"),
            ("gain", _DOUBLE, "parameter"),
            ("initialValue", _DOUBLE, "parameter"),
        ),
        (_double("gain", "gain", 1.0), _double("initialValue", "initial", 0.0)),
        _map(**{"in": "in", "reset_value": "resetValue", "trigger": "trigger"}),
        _map(out="out"),
    ),
    ComponentSpec(
        "OnCounter",
        "com/bactalk/g36/BOnCounter",
        ...
        (_double("initialValue", "initial", 0.0),),
        _map(trigger="trigger", reset="reset"),
        _map(out="out"),
    ),
    ComponentSpec(
        "WetBulb",
        "com/bactalk/g36/BWetBulb",
        (BlockKind.WET_BULB_TEMPERATURE,),
        (
            ("dryBulb", _STATUS_NUMERIC, "input"),
            ("relativeHumidity", _STATUS_NUMERIC, "input"),
            ("out", _STATUS_NUMERIC, "output"),
        ),
        (),
        _map(dry_bulb="dryBulb", relative_humidity="relativeHumidity"),
        _map(out="out"),
    ),
    ComponentSpec(
        "LimitSlewRate",
