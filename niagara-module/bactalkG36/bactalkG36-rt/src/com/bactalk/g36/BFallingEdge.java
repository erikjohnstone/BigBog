...
import com.bactalk.g36.kernel.FallingEdge;
...
/** boolean_falling_edge with host-tick semantics: one execution true per falling edge of in. */
public final class BFallingEdge extends BKernelComponent {
  ...
  public static final Type TYPE = Sys.loadType(BFallingEdge.class);

  private FallingEdge kernel;
  ...
  protected void rebuildKernel() {
    kernel = new FallingEdge(getInitialValue().getBoolean());
  }
