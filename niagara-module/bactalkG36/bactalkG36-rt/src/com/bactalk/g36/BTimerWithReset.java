...
import com.bactalk.g36.kernel.TimerWithReset;
...
/** Plant Utilities.TimerWithReset: a rising edge on reset restarts the timer. */
public final class BTimerWithReset extends BKernelComponent {
  ...
  public static final Type TYPE = Sys.loadType(BTimerWithReset.class);

  private TimerWithReset kernel;
  ...
  protected void rebuildKernel() {
    kernel = new TimerWithReset(seconds(getThreshold()));
  }
